...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("https://todo-mern-ia3f.onrender.com/user/login", {
        email,
        password,
      });
  ...
  return (
    <div className="h-screen flex">
      <div className="bg-[#292c31] lg:w-[50vw] lg:h-full">
        ...
        <div onClick={authLogin} className="h-10 flex gap-4 items-center  align-middle border-1 border-white ml-49 w-[300px] mt-8 rounded">
